        ...
        <div class="col-md-12 d-flex align-items-stretch grid-margin">
            <div class="row flex-grow">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Data Buku | <b>{{$data->judul}}</b> </h4>
                            <form class="forms-sample">
                                ...
                                <div class="form-group{{ $errors->has('cetakan') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="cetakan" type="number" maxlength="10" class="form-control" name="cetakan" value="{{ $data->cetakan }}" required>
                                ...
                                <div class="form-group{{ $errors->has('keterangan') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="keterangan" type="text" class="form-control" name="keterangan" value="{{ $data->keterangan }}">{{ $data->keterangan }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('tautan') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tautan" type="text" class="form-control" name="tautan" value="{{ $data->tautan }}">
                                ...
                                <input type="hidden" name="foto_lama" value="{{ $data->cover }}">
