...
<head>
  ...
  <title>Perpus | SMK Muhammadiyah 7 Jakarta</title>
  <!-- plugins:css -->
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="#" style="color: #2d2d2d">
          <img src="{{ asset('images/logo.png') }}" width="30" height="30" alt="">&nbsp;| Perpus
        </a>
        <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
          <span class="icon-menu"></span>
          <i class="mdi mdi-menu icon-menu" style="color: #fff;"></i>
        </button>
      </div>
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © {{date('Y')}}
              <a href="#" target="_blank">SMK Muhammadiyah 7 Jakarta</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
